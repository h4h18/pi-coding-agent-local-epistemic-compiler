        ...
        [
          {
            ...
            unifiedDiff: ["--- a/src/n.txt", "+++ b/src/n.txt", "@@ -1,1 +1,1 @@", "-two", "+TWO"].join("\n"),
    ...
    [
      {
        ...
        unifiedDiff: ["--- a/src/empty.txt", "+++ b/src/empty.txt", "@@ -0,0 +1,1 @@", "+hello"].join("\n"),
        insertedLineEnding: "LF",
        finalNewline: "PRESENT",
      },
    ],
  ...
  expectCode(
    () =>
      apply(
        ...
        [dirEntry("src"), symlinkEntry("src/link", "hello.txt"), fileEntry("src/hello.txt", "hi\n")],
      ),
    "SYMLINK_ALIAS",
  );
});
  ...
  const result = apply(
    [
      ...
      },
      {
        ...
        unifiedDiff: ["--- a/src/new.txt", "+++ b/src/new.txt", "@@ -1,1 +1,1 @@", "-old", "+new"].join("\n"),
        insertedLineEnding: "LF",
        finalNewline: "PRESENT",
      },
      {
    ...
    [
      {
        ...
        unifiedDiff: ["--- a/src/bom.txt", "+++ b/src/bom.txt", "@@ -1,1 +1,1 @@", "-hi", "+ho"].join("\n"),
        insertedLineEnding: "LF",
        finalNewline: "PRESENT",
      },
    ],
        ...
        [
          {
            ...
            unifiedDiff: ["--- a/src/zero.bin", "+++ b/src/zero.bin", "@@ -1,1 +1,1 @@", "-x", "+y"].join("\n"),
            insertedLineEnding: "LF",
            finalNewline: "PRESENT",
          },
        ],
