...
import {
  ...
  GrantRunnerProjectResponseSchema,
...
export const OPENAPI_COMPONENT_SCHEMAS: Readonly<Record<string, TSchema>> = {
  ...
  GrantRunnerProjectRequest: GrantRunnerProjectRequestSchema,
  GrantRunnerProjectResponse: GrantRunnerProjectResponseSchema,
  WorkspaceProjection: WorkspaceProjectionSchema,
  CreateRunRequest: CreateRunRequestSchema,
  RunProjection: RunProjectionSchema,
  RunAgentsPage: RunAgentsPageSchema,
